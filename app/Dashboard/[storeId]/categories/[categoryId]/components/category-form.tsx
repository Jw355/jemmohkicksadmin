...
import { AlertModal } from "@/components/modal/alert-model";
...
export const CategoryForm: React.FC<CatergoryFormProps> = ({
  initialData,
  billboards,
}) => {
  ...
  const [open, stetOpen] = useState(false);
  const [loading, setLoading] = useState(false);

  const title = initialData ? "Edit category" : "Create category";
  const description = initialData ? "Edit a category" : "Add a new category";
  const toastMessage = initialData ? "Category updated" : "C`ategory created";
